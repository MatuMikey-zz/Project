...
Sensor0NeuralNetwork, trainLoss0, testLoss0 = train(4,1,50,10,0)
#print ("Sensor0 Test Loss:", testLoss0, "Train Loss:", trainLoss0)
Sensor1NeuralNetwork, trainLoss1, testLoss1 = train(4,1,50,10,1)
#print ("Sensor1 Test Loss:", testLoss1, "Train Loss:", trainLoss1)
Sensor2NeuralNetwork, trainLoss2, testLoss2 = train(4,1,50,10,2)
