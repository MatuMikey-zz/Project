...
plt.figure(0)
plt.title("Training Loss Over 1000 Training Epochs for Sensor 1")
plt.ylabel("Loss as percentage")
plt.xlabel("Epochs")
plt.plot(trainLoss0)
plt.figure(1)
plt.title("Test Loss Over 1000 Training Epochs for Sensor 1")
plt.ylabel("Loss as percentage")
plt.xlabel("Epochs")
plt.plot(testLoss0)

plt.figure(2)
plt.title("Training Loss Over 1000 Training Epochs for Sensor 2")
plt.ylabel("Loss as percentage")
plt.xlabel("Epochs")
plt.plot(trainLoss1)
plt.figure(3)
plt.title("Test Loss Over 1000 Training Epochs for Sensor 2")
plt.ylabel("Loss as percentage")
plt.xlabel("Epochs")
plt.plot(testLoss1)

plt.figure(4)
plt.title("Training Loss Over 1000 Training Epochs for Sensor 3")
plt.ylabel("Loss as percentage")
plt.xlabel("Epochs")
plt.plot(trainLoss2)
plt.figure(5)
plt.title("Test Loss Over 1000 Training Epochs for Sensor 3")
plt.ylabel("Loss as percentage")
plt.xlabel("Epochs")
plt.plot(testLoss2)
