...
float weights[45] = {-0.153715, 0.164423, 0.330319, -0.610114, -0.642378, -0.982493, -0.747027, -0.444135, 0.770075, 0.273298, -0.747873, -0.995816, 0.585252, 0.481809, 0.262934, 0.900846, -0.631292, 0.943123, 0.658901, -0.558262, -0.229463, 0.375072, -0.000077, -0.991619, 0.101101, 0.048657, 0.518033, -0.019342, 0.974807, -0.930185, 0.84217, 0.833894, 0.976077, 0.731074, -0.436505, -0.749857, 0.447282, 0.250051, -0.652632, -0.506854, 0.714463, -0.781608, -0.145801, 0.138788, -0.612724};
volatile int weightCounter = 0;
volatile float outputs[33] = {0};
    ...
    switch ( appData.state )
    {
        ...
        case APP_STATE_WRITE_TO_WIFI:
        {
            ...
            if(appData.receivedData){
                ...
                output1 = output1 + 1.0*weights[44];
                ...
                output = output/100;
                buffer[4] = output; 
                output1 = 0; for(i = 0; i < 33; i++){outputs[i] = 0;}
            }
            //Neural network
