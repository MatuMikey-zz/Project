    ...
    switch ( appData.state )
    {
        ...
        case APP_STATE_WRITE_TO_WIFI:
        {
            ...
            if(appData.receivedData){
                ...
                T1 = ((1.0/((1.0/298.15)+(1.0/3800.0)*(log(R1/1000.0)))-273.15)-23.829)/(30.789-23.829);
                
                sensorInput2 = (float)appData.sensorData[2]*256 + appData.sensorData[3];
                R2 = 1000.0/((1023.0/(1023-sensorInput2))-1.0);
                T2 = ((1.0/((1.0/298.15)+(1.0/3800.0)*(log(R2/1000.0)))-273.15)-22.728)/(32.853-22.728);
                ...
                output1 = (output1/12.0)*(36.584-21.541)+21.541; // linear output
                output = output1*100;
